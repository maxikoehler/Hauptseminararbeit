...
\commenting{Deviation through ODE's and its parameters. Swing equation vs. algebraic equations. Considering transformator (symmetrical components) resistance, current injection from the grid-node (Norton equivalent), impedances from the line.}
